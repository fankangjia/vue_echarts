...
import axios from 'axios'
 export default {
        ...
        echarts1_option:{
          tooltip: {
              ...
              formatter: function (data) {
                    return data.name + ' <br> ' + data.value[2];
              }
          },
          dataRange: {
            min : 0,
    ...
    watch: {
      chartData(newValue, oldValue) {
        ...
        if(that.citynow=='bh'){
            ...
            series : [
                {
                    data: that.convertData([{ name: '包河区', value: 5 }]),
                }
            ]
            })
        }
    ...
    methods: {
      seriesDate() {
        var that = this
         ...
         axios.get('http://b.fankangjia.top/web/index.php?c=site&a=entry&do=map&m=ns_klny')
      ...
      changedata(){
        ...
        if(that.citynow=='bh'){
            ...
            series : [
                {
                    data: that.convertData([{ name: '包河区', value: 1 }]),
                }
            ]
            })
        }
      ...
      changemap(){
          if(this.citynow=='bh'){
              this.citynow='hf'
              this.datahf()
              this.chartcontainer.setOption(this.echarts2_option)
              this.changedata()
          }else{
              this.citynow='bh'
              this.databh()
    ...
    mounted: function () {
      ...
      this.chartcontainer.setOption(this.echarts1_option)
      //绑定点击方法
      this.chartcontainer.on('click',this.changemap)
      //调用异步方法获取数据
      this.seriesDate()
       //立刻切换成大图
      this.changedata()
